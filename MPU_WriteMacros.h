...
//9250 Self Test Gyro
#define SELF_TEST_X_GYRO_WRITE_xg_st_data(Data)         MPUi2cWriteByte(0x00, Data)			//   self test output generated during manufacturing tests
#define SELF_TEST_Y_GYRO_WRITE_yg_st_data(Data)         MPUi2cWriteByte(0x01, Data)			//   self test output generated during manufacturing tests
#define SELF_TEST_Y_GYRO_WRITE_I2C_MST_VDDIO(Data)      MPUi2cWrite(0x01, 1,7, Data)		//   self test output generated during manufacturing tests
#define SELF_TEST_Z_GYRO_WRITE_zg_st_data(Data)         MPUi2cWriteByte(0x02, Data)			//   self test output generated during manufacturing tests
//6050 Accelerometer Offsets
#define A_OFFSET_WRITE_A_OFFS(Shift, Data)              MPUi2cWriteInt(0x06 + (Shift * 2), Data)//
...
//#define SELF_TEST_X_ACCEL_WRITE_XA_ST_DATA(Data)      MPUi2cWriteByte(0x0D, Data)			//   self test output generated during manufacturing tests
//#define SELF_TEST_Y_ACCEL_WRITE_YA_ST_DATA(Data)      MPUi2cWriteByte(0x0E, Data)			//   self test output generated during manufacturing tests
//#define SELF_TEST_Z_ACCEL_WRITE_ZA_ST_DATA(Data)      MPUi2cWriteByte(0x0F, Data)			//   self test output generated during manufacturing tests
...
//Both
#define XG_OFFSET_WRITE_OFFS_USR(Shift, Data)           MPUi2cWriteInts(0x13 + (Shift * 2), Data)		//   Remove DC bias from the gyro sensor Step 0.0305 dps
...
#define SMPLRT_DIV_WRITE_SMPLRT_DIV(Data)               MPUi2cWriteByte(0x19, Data)			//   Divides the internal sample rate  controls sensor data output rate, FIFO sample rate.   SAMPLE_RATE= Internal_Sample_Rate / (1 + SMPLRT_DIV)
...
#define WOM_THR_WRITE_WOM_THRESHOLD(Data)               MPUi2cWriteByte(0x1F, Data)			//   Threshold Value for the Wake on Motion Interrupt

#define FIFO_EN_WRITE_FIFO_EN(Data)                     MPUi2cWriteByte(0x23, Data)			//   Adds Temp data to FIFO
...
#define I2C_MST_CTRL_WRITE_MULT_MST_EN(Data)            MPUi2cWrite(0x24, 1, 7, Data)		//   *Enables multi-master capability. When disabled, clocking to the I2C_MST_IF
																							//   can be disabled when not in use and the logic to detect lost arbitration is disabled.
#define I2C_MST_CTRL_WRITE_WAIT_FOR_ES(Data)            MPUi2cWrite(0x24, 1, 6, Data)		//   Delays the data ready interrupt until external sensor data is loaded. If
																							//   I2C_MST_IF is disabled, the interrupt will still occur.
#define I2C_MST_CTRL_WRITE_SLV_3_FIFO_EN(Data)          MPUi2cWrite(0x24, 1, 5, Data)		//   1 – write EXT_SENS_DATA registers associated to SLV_3 (as determined by
																							//   I2C_SLV0_CTRL and I2C_SLV1_CTRL and I2C_SLV2_CTRL) to the FIFO at the sample rate;
																							//   0 – function is disabled
#define I2C_MST_CTRL_WRITE_I2C_MST_P_NSR(Data)          MPUi2cWrite(0x24, 1, 4, Data)		//   This bit controls the I2C Master’s transition from one slave read to the next
																							//   slave read. If 0, there is a restart between reads. If 1, there is a stop between reads.
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK(Data)            MPUi2cWrite(0x24, 4, 3, Data)		//   I2C_MST_CLK is a 4 bit unsigned value which configures a divider on the MPU9250 internal 8MHz clock. 																							//   It sets the I2C master clock speed according to the following table:#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_348(...)         MPUi2cWrite(0x24, 4, 3, 0)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_333(...)         MPUi2cWrite(0x24, 4, 3, 1)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_320(...)         MPUi2cWrite(0x24, 4, 3, 2)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_308(...)         MPUi2cWrite(0x24, 4, 3, 3)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_296(...)         MPUi2cWrite(0x24, 4, 3, 4)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_286(...)         MPUi2cWrite(0x24, 4, 3, 5)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_276(...)         MPUi2cWrite(0x24, 4, 3, 6)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_267(...)         MPUi2cWrite(0x24, 4, 3, 7)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_258(...)         MPUi2cWrite(0x24, 4, 3, 8)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_500(...)         MPUi2cWrite(0x24, 4, 3, 9)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_471(...)         MPUi2cWrite(0x24, 4, 3, 10)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_444(...)         MPUi2cWrite(0x24, 4, 3, 11)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_421(...)         MPUi2cWrite(0x24, 4, 3, 12)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_400(...)         MPUi2cWrite(0x24, 4, 3, 13)			//   * 13 400 kHz 
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_381(...)         MPUi2cWrite(0x24, 4, 3, 14)
#define I2C_MST_CTRL_WRITE_I2C_MST_CLK_364(...)         MPUi2cWrite(0x24, 4, 3, 15) 
...
#define I2C_SLV0_CTRL_WRITE_I2C_SLV0_REG_DIS(Data)      MPUi2cWrite(0x27, 1, 5, Data)		//   When set, the transaction does not write a register value, it will only read data, or write data
#define I2C_SLV0_CTRL_WRITE_I2C_SLV0_GRP(Data)          MPUi2cWrite(0x27, 1, 4, Data)		//   External sensor data typically comes in as groups of two bytes. This bit is used to determine if the groups are from the slaves
...
#define I2C_SLV0_CTRL_WRITE_I2C_SLV0_LENG(Data)         MPUi2cWrite(0x27, 4, 3, Data)		//   Number of bytes to be read from I2C slave 0
...
#define I2C_SLV1_REG_WRITE_I2C_SLV1_REG(Data)           MPUi2cWriteByte(0x29, Data)			//   I2C STUFF
...
#define I2C_SLV2_REG_WRITE_I2C_SLV2_REG(Data)           MPUi2cWriteByte(0x2C, Data)			//   I2C STUFF
...
#define I2C_SLV3_REG_WRITE_I2C_SLV3_REG(Data)           MPUi2cWriteByte(0x2F, Data)			//   I2C STUFF
...
// I2C Slave 4
#define I2C_SLV4_ADDR_WRITE_I2C_SLV4_RNW(Data)          MPUi2cWrite(0x31, 1, 7, Data)		//   1 – Transfer is a read, 0 – Transfer is a write
#define I2C_SLV4_ADDR_WRITE_I2C_ID_4(Data)              MPUi2cWrite(0x31, 7, 6, Data)		//   Physical address of I2C slave 4
#define I2C_SLV4_REG_WRITE_I2C_SLV4_REG(Data)           MPUi2cWriteByte(0x32, Data)			//   I2C slave 0 register address from where to begin data transfer
#define I2C_SLV4_DO_WRITE_I2C_SLV4_DO(Data)             MPUi2cWriteByte(0x33, Data)			//   Data to be written to I2C Slave 4 if enabled.
#define I2C_SLV4_CTRL_WRITE_I2C_SLV4_EN(Data)           MPUi2cWrite(0x34, 1, 7, Data)		//   1 – Enable data transfer with this slave at the sample rate. If read
...
#define I2C_SLV4_CTRL_WRITE_SLV4_DONE_INT_EN(Data)      MPUi2cWrite(0x34, 1, 6, Data)		//   1 – Enables the completion of the I2C slave 4 data transfer to cause an interrupt.
																							//	0 – Completion of the I2C slave 4 data transfer will not cause an interrupt.
#define I2C_SLV4_CTRL_WRITE_I2C_SLV4_REG_DIS(Data)      MPUi2cWrite(0x34, 1, 5, Data)		//   When set, the transaction does not write a register value, it will only read data, or write data
#define I2C_SLV4_CTRL_WRITE_I2C_MST_DLY(Data)           MPUi2cWrite(0x34, 5, 4, Data)		//   When enabled via the I2C_MST_DELAY_CTRL, those slaves will only be enabled every (1+I2C_MST_DLY) samples (as determined by the SMPLRT_DIV and DLPF_CFG registers.
#define I2C_SLV4_DI_WRITE_I2C_SLV4_DI(Data)             MPUi2cWriteByte(0x35, Data)			//   Data read from I2C Slave 4.
...
#define I2C_SLV0_DO_WRITE_I2C_SLV0_DO(Data)             MPUi2cWriteByte(0x63, Data)			//   Data out when slave 0 is set to write
...
#define SIGNAL_PATH_FULL_RESET_WRITE_RESET(...)			MPUi2cWrite(0x6A, 3, 2, 0b1111)		//  Reset DMP, FIFO, gyro, accel and temp signal paths
#define SIGNAL_PATH_RESET_WRITE_RESET(...)			    MPUi2cWrite(0x6A, 3, 2, 0b0111)		//  Reset gyro,accel, temp signal paths
...
//6500 and 9250
#define X_OFFSET_WRITE_0x77_X_OFFS(Shift, Data)            MPUi2cWriteInt(0x77 + (Shift * 3),  Data)			//   accelerometer offset cancellation
#define XA_OFFSET_H_WRITE_0x77_XA_OFFS(Data)            MPUi2cWriteInt(0x77,  Data)			//   X accelerometer offset cancellation
#define YA_OFFSET_H_WRITE_0x77_YA_OFFS(Data)            MPUi2cWriteInt(0x7A,  Data)			//   Y accelerometer offset cancellation
#define ZA_OFFSET_H_WRITE_0x77_ZA_OFFS(Data)            MPUi2cWriteInt(0x7D,  Data)			//   Z accelerometer offset cancellation
...
#define EXT_I2C_ST1_READ_BYTE(Data)						MPUi2cReadByte(0x49, Data)
#define EXT_I2C_ST1_READ_DATA_READY(Data)				MPUi2cRead(0x49, 1,0, Data)
#define EXT_I2C_ST1_READ_OVERRUN(Data)					MPUi2cRead(0x49, 1,1, Data)
#define EXT_I2C_READ_RAW_COMPASS(Data)					MPUi2cReadInts(0x4A, 3, Data)
#define EXT_I2C_ST1_READ_BYTE(Data)						MPUi2cReadByte(0x4D, Data)
#define EXT_I2C_ST1_READ_DATA_ERROR(Data)				MPUi2cRead(0x4D, 1,2 Data)
#define EXT_I2C_ST1_READ_SENSOR_OVERFLOW(Data)			MPUi2cRead(0x4D, 1,3 Data)
#define EXT_I2C_ST1_READ_BITM(Data)						MPUi2cRead(0x4D, 1,4 Data)
...
//Read Only
#define AKM_WHOAMI_READ(compass_addr, Data)					MPUi2cReadByte(compass_addr,0x00,Data)	//Device ID of AKM. It is described in one byte and fixed value.  0x48: fixed
#define AKM_INFO_READ(compass_addr, Data)					MPUi2cReadByte(compass_addr,0x01,Data)	//INFO[7:0]: Device information for AKM



#define AKM_ST1_READ_BYTE(compass_addr, Data)				MPUi2cReadByte(compass_addr,0x02,Data)	//BIT 0 and Bit 1
#define AKM_ST1_READ_DATA_READY(compass_addr, Data)			MPUi2cRead(compass_addr,0x02,1,0,Data)	//BIT 0 DRDY bit turns to “1” when data is ready in single measurement mode or self-test mode. It returns to “0” when any one of ST2 register or measurement data register (HXL to HZH) is read.
#define AKM_ST1_READ_DATA_OVERRUN(compass_addr, Data)		MPUi2cRead(compass_addr,0x02,1,1,Data)	//BIT 1 mpu9250 ONLY DOR bit turns to “1” when data has been skipped in continuous measurement mode or external trigger measurement mode. It returns to “0” when any one of ST2 register or measurement data register (HXL~HZH) is read.

#define AKM_DATA_READ_RAW_COMPASS_DATA(compass_addr, Data)	MPUi2cReadBytes(compass_addr,0x03,6,Data) // Read the six raw data and ST2 registers sequentially into data array
#define SwapBytes(Data)										{int8_t L = Data>>8; Data = Data<<8; Data |= L;}
#define AKM_DATA_READ_RAW_COMPASS_SWAP(compass_addr, Data)	MPUi2cReadInts(compass_addr,0x03,3,Data);SwapBytes(Data[0]);SwapBytes(Data[1]);SwapBytes(Data[2]) //Read 8Bytes of Data
#define AKM_DATA_READ_RAW_COMPASS(compass_addr, Data)		MPUi2cReadInts(compass_addr,0x03,3,Data) //Read 8Bytes of Data
#define AKM_HX_READ_HX(compass_addr, Data)					MPUi2cReadInt(compass_addr,0x03,&Data);SwapBytes(Data)
#define AKM_HY_READ_HY(compass_addr, Data)					MPUi2cReadInt(compass_addr,0x05,&Data);SwapBytes(Data)
#define AKM_HZ_READ_HZ(compass_addr, Data)					MPUi2cReadInt(compass_addr,0x07,&Data);SwapBytes(Data)

#define AKM_ST2_READ_BYTE(compass_addr, Data)				MPUi2cReadByte(compass_addr,0x09,Data)	// BIT 2, BIT 3, BIT 4
#define AKM_ST2_READ_SENSOR_OVERFLOW(compass_addr, Data)	MPUi2cRead(compass_addr,0x09,1,3,Data)	// BIT 3 HOFL In single measurement mode and self-test mode, magnetic sensor may overflow even though measurement data register is not saturated. In this case, measurement data is not correct and HOFL bit turns to “1”. When next measurement stars, it returns to “0”.
#define AKM_ST2_READ_DATA_ERROR(compass_addr, Data)			MPUi2cRead(compass_addr,0x09,1,2,Data)	// BIT 2 DERR  When data reading is started out of data readable period, the read data are not correct. In this case, data read error occurs and DERR bit turns to “1”. When ST2 register is read, it returns to “0”.
#define AKM_ST2_READ_BITM(compass_addr, Data)				MPUi2cRead(compass_addr,0x09,1,4,Data)	// BIT 4 Output bit setting Mirror of CNTL1 BIT 4  0 = 14-BIT 1 = 16-BIT
...
#define AKM_SOFT_RESET(compass_addr)								MPUi2cReadByte(compass_addr,0x0B,1)


#define AKM_ASTC_WRITE_GEN_MAG_FIELD(compass_addr, Data)		MPUi2cWrite(compass_addr,0x0C,1,6,1) //Generate magnetic field for self-test
#define AKM_ASTC_WRITE_NORMAL(compass_addr, Data)				MPUi2cWrite(compass_addr,0x0C,1,6,0) //Normal

//#define AKM_ASTC_WRITE_All(compass_addr, Data)				MPUi2cWrite(compass_addr,0x0F,1,0,1) // Once I2CDIS is turned to “1” and I2C bus interface is disabled, re-setting I2CDIST to “0” is prohibited. To enable I2C bus interface, reset AK8975C by turning VDD to OFF (0V) once.

//ASAX, ASAY, ASAZ: Sensitivity Adjustment values
#define AKM_ASAXYZ_WRITE_SENS_ADJ_XYZ(compass_addr, Data)		MPUi2cWriteBytes(compass_addr,0x10,3,Data)
#define AKM_ASAX_WRITE_SENS_ADJ_X(compass_addr, Data)			MPUi2cWriteByte(compass_addr,0x10,Data)
#define AKM_ASAY_WRITE_SENS_ADJ_Y(compass_addr, Data)			MPUi2cWriteByte(compass_addr,0x11,Data)
#define AKM_ASAZ_WRITE_SENS_ADJ_Z(compass_addr, Data)			MPUi2cWriteByte(compass_addr,0x12,Data)

#define AKM_ASAXYZ_READ_SENS_ADJ_XYZ(compass_addr, Data)		MPUi2cReadBytes(compass_addr,0x10,3,Data)
#define AKM_ASAX_READ_SENS_ADJ_X(compass_addr, Data)			MPUi2cReadByte(compass_addr,0x10,Data)
#define AKM_ASAY_READ_SENS_ADJ_Y(compass_addr, Data)			MPUi2cReadByte(compass_addr,0x11,Data)
#define AKM_ASAZ_READ_SENS_ADJ_Z(compass_addr, Data)			MPUi2cReadByte(compass_addr,0x12,Data)
